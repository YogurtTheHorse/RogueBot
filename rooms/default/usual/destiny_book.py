...
name = locale_manager.get('rooms.default.usual.destiny_book.phrase_1')
...
def action(user, reply, text):
		...
		if question == 'first':
			if text == locale_manager.get('rooms.default.usual.destiny_book.phrase_2'):
			...
			if text == locale_manager.get('rooms.default.usual.destiny_book.phrase_3'):
			...
			if text == locale_manager.get('rooms.default.usual.destiny_book.phrase_4'):
			...
			if text == locale_manager.get('rooms.default.usual.destiny_book.phrase_5'):
			...
			reply(locale_manager.get('rooms.default.usual.destiny_book.phrase_6'), photo=BOOK_END_STICKER)
...
def get_actions(user):
	...
	return [ locale_manager.get('rooms.default.usual.destiny_book.phrase_7'), locale_manager.get('rooms.default.usual.destiny_book.phrase_8')]
