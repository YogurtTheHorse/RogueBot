...
def action(user, reply, text):
	...
	MADE_SOLUTION_TEXT = locale_manager.get('rooms.default.usual.devil.phrase_101')
	CURSE_TEXT = locale_manager.get('rooms.default.usual.devil.phrase_102')
	...
	if question == 'first':
		if text == locale_manager.get('rooms.default.usual.devil.phrase_3'):
			...
			reply(locale_manager.get('rooms.default.usual.devil.phrase_103'))
			user.leave(reply)
		...
		if text == locale_manager.get('rooms.default.usual.devil.phrase_7'):
			...
			reply(locale_manager.get('rooms.default.usual.devil.phrase_104').format(usr_name))
			user.set_room_temp('question', 'third')
	elif question == 'third':
		if text == locale_manager.get('rooms.default.usual.devil.phrase_10'):
			reply(locale_manager.get('rooms.default.usual.devil.phrase_105').format(CURSE_TEXT))
			user.max_hp -= 50
			user.leave(reply)
			...
			reply(locale_manager.get('rooms.default.usual.devil.phrase_106'))
			user.set_room_temp('question', 'fifth')
	elif question == 'forth':
		if text == locale_manager.get('rooms.default.usual.devil.phrase_13'):
			reply(locale_manager.get('rooms.default.usual.devil.phrase_107').format(CURSE_TEXT))
			user.max_hp -= 50
			user.leave(reply)
		elif text == locale_manager.get('rooms.default.usual.devil.phrase_14'):
			reply(locale_manager.get('rooms.default.usual.devil.phrase_108'))
			user.set_room_temp('question', 'fifth')
	elif question == 'fifth':
		if text == locale_manager.get('rooms.default.usual.devil.phrase_15'):
			...
			reply(locale_manager.get('rooms.default.usual.devil.phrase_109'))
		...
		if text == locale_manager.get('rooms.default.usual.devil.phrase_20'):
			reply(locale_manager.get('rooms.default.usual.devil.phrase_110'))
			user.leave(reply)
...
def get_actions(user):
	...
	if question == 'first':
		...
		ans = [ locale_manager.get('rooms.default.usual.devil.phrase_31'), locale_manager.get('rooms.default.usual.devil.phrase_32'), locale_manager.get('rooms.default.usual.devil.phrase_33'), locale_manager.get('rooms.default.usual.devil.phrase_111') ]
	elif question == 'sixth':
