...
def enter(user, reply):
	msg = (
		...
		'трупов с прострелянной головой...\n\nОн говорит вам: «О, новобранец. '
...
def action(user, reply, text):
	...
	if question == 'first':
		...
		if text == 'Да':
			...
			reply('Ну конечно не умеешь, ведь магия - это ересь, ведь правда, боец?')
			...
			reply('Оо, вижу, ты заметил мой плакатик. Ну и как тебе? Понравилась, да?')
