...
def action(user, reply, text):
	...
	if question == 'first':
		...
		if text == 'Я пойду, пожалуй':
			...
			reply('У меня много имен, {0}. В разных культурах меня называли по разному. я помогал людям добиться превосходных результатов, начинал войны, насылал болезни.0'.format(usr_name))
