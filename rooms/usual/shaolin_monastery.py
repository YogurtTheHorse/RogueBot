...
def enter(user, reply):
	reply('Ты видишь перед собой монастырь.\nНа входе один из монахов взял тебя за локоть и отвел в сторону.\n-Кто ты? А, впрочем неважно, у нас сейчас как раз тренировка. Скажи мне, друг, насколько крепка твоя защита?')
...
def action(user, reply, text):
	...
	if text == actions[0]:
		...
		user.defence += 5
		reply('Ты принял участие в тренировке монахов, теперь твоё тело крепче. Это стоило тебе добровольного пожертвования.')
		if not user.paid(50):
